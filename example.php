...
/* Send an SMS using GoSMS. You can run this file 3 different ways:
 *
...
// Step 1: Get the Ultimate SMS API library from https://github.com/levart/GoSMS-API,
...
// Step 5: Replace your Install URL like https://mywebhost.com/sms/api with
// <sms/api> is mandatory.

$url = 'https://gosms.com/demo/sms/api';

// the sms body
$sms = 'test message from Go SMS';
...
// Step 6: instantiate a new Go SMS API request
$client = new GoSMSAPI();
